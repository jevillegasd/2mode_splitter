...
for i = 1:length(circuits)    
    ...
    for j = 1:length(data)
        ...
        ic = str2double(data{j}.params.CurrentCh2)*i_mult;
...
xlim([1520, 1580])
ylim([-30, 0])
title(tcl,'Mode Modulator using Adjoint Optimized Y-Splitters. TE1 Input - 400 um Heaters.')
